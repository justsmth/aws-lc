...
# -Wl,--undefined=main: Force the linker to resolve 'main' symbol from static libraries.
#   This is needed because WASI's libc defines a weak main symbol, and without
#   this flag, the linker may not pull in main() from static libraries like
#   boringssl_gtest_main.a, resulting in "undefined_weak:main" runtime errors.
#
...
set(WASI_LINK_FLAGS "-lwasi-emulated-signal -lwasi-emulated-process-clocks -Wl,--undefined=main -Wl,-z,stack-size=1048576 -Wl,--initial-memory=134217728 -Wl,--max-memory=268435456")
...
# Define WASI for preprocessor detection in AWS-LC code
# This is used alongside OPENSSL_WASM which is defined when __wasm__ is detected
add_compile_definitions(OPENSSL_WASI)
